...
<section class="checkout_area section_gap">
    <form action="../../../../Du_an_1/Controller/index_user.php?request=confirm-payment" method="POST">
        <div class="container">
                ...
                <div class="row mb-5">
                     <?php foreach($list_all_address as $value):extract($value) ?>
                        ...
                        <div class="col-lg-11 mb-3 d-flex justify-content-between">
                            ...
                            <div class="col-lg-1 mr-1"><a href="../../../../Du_an_1/Controller/index_user.php?request=delete-address&id_address='.$id_dia_chi.'">Xóa</a></div>';  
                            ?>
...
<div class="modal fade" id="addAddress" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1" aria-labelledby="staticBackdropLabel" aria-hidden="true">
  <div class="modal-dialog">
    <div class="modal-content">
      ...
      <div class="modal-body">
        <form method="POST" action="../../../../Du_an_1/Controller/index_user.php?request=addtional-address">
            <div class="mb-3">
   ...
   document.addEventListener('DOMContentLoaded', () => {
        ...
        checkboxes.forEach((checkbox) =>  {
            checkbox.addEventListener('change', () =>  {
                    ...
                    window.location.href = `../../../../Du_an_1/Controller/index_user.php?request=change-address&id_address=${checkboxId}` ;            
            });
        });
    });
</script>