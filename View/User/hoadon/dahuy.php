                        ...
                        <nav class="navbar navbar-expand-lg navbar-light bg-light navbar-custom">
                            <div class="collapse navbar-collapse" id="navbarNav">
                                <ul class="navbar-nav d-flex justify-content-around w-100">
                                    ...
                                    <li class="nav-item">
                                        <a class="nav-link text-warning" href="../../../../Du_an_1/Controller/index_user.php?request=cancel">Đã Hủy</a>
                                    </li>
                                </ul>
                             </div>
                        </nav>
                        ...
                        <?php foreach( $list_cancel_bill as $value):extract($value)?>
                            <div class="order_box mb-3 ">
                                ...
                                <div class="row mt-4">
                                    ...
                                    <div class="col-2">
                                        <div class="d-inline">
                                            <a href="../../../../Du_an_1/Controller/index_user.php?request=received-product&id_bill=<?=$id_hoa_don?>" class="btn btn-danger">Mua lại</a>
                                        </div>
                                    </div>
