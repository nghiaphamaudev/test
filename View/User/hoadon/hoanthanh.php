                        ...
                        <nav class="navbar navbar-expand-lg navbar-light bg-light navbar-custom">
                            <div class="collapse navbar-collapse" id="navbarNav">
                                <ul class="navbar-nav d-flex justify-content-around w-100">
                                    ...
                                    <li class="nav-item">
                                        <a class="nav-link text-warning" href="../../../../Du_an_1/Controller/index_user.php?request=complete">Hoàn Thành</a>
                                    </li>
                                    <li class="nav-item">
                        ...
                        <?php foreach( $list_complete_bill as $value):extract($value)?>
                            <div class="order_box mb-3 ">
                                ...
                                <div class="row mt-4">
                                    ...
                                    <div class="col-2">
                                        <div class="d-inline">
                                            <a href="../../../../Du_an_1/Controller/index_user.php?request=received-product&id_bill=<?=$id_hoa_don?>" class="btn btn-success">Đánh giá</a>
                                        </div>
                                    </div>
