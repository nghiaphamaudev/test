...
<body>
        ...
        <div class="main_menu">
            <div class="container">
                <nav class="navbar navbar-expand-lg navbar-light w-100">
                    ...
                    <a class="navbar-brand logo_h" href="../../../Du_an_1/Controller/index_user.php">
                        <img src="../../../Du_an_1/images_giao_dien/flat-laptop-logo-template_23-2149017459.avif" style="height: 90px; width: 90px;" alt="" />
                    </a>
                        ...
                        <div class="row w-100 mr-0">
                            <div class="col-lg-5 pr-0">
                                <ul class="nav navbar-nav center_nav pull-right">
                                    <li class="nav-item active">
                                        <a class="nav-link" href="../../../Du_an_1/Controller/index_user.php">Trang chủ</a>
                                    </li>
                                    <li class="nav-item">
                                        <a class="nav-link" href="../../../Du_an_1/Controller/index_user.php?request=list-product">Sản Phẩm</a>
                                    </li>
                                    <li class="nav-item">
                            ...
                            <div class="col-lg-7 pr-0">
                                <ul class="nav navbar-nav navbar-right right_nav pull-right">
                                    <form class="form-inline" action="../../../Du_an_1/Controller/index_user.php?request=filter" method="POST">
                                    ...
                                    <li class="nav-item ">
                                        ...
                                        <a href="../../../Du_an_1/Controller/index_user.php?request=cart" class="icons" style="font-size: 25px; margin-right: 15px">
                                    ...
                                    <li class="nav-item">
                                        ...
                                        ?>
                                            <a href="../../../Du_an_1/View/User/login.php" class="icons">
    ...
    <div class="modal fade" id="sua-user" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
        <form action="../../../Du_an_1/Controller/index_user.php?request=update-acc" method="POST" enctype="multipart/form-data">
                ...
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" id="recipient-name" value="<?=$_SESSION['user']['ho_ten']?>" name="user_name">
                        </div>
                        <div class="form-group">
                            <label for="recipient-name" class="col-form-label">Email:</label>
                            <input type="text" class="form-control" id="recipient-name" value="<?=$_SESSION['user']['gmail']?>" name="email">
                        </div>
                        <div class="form-group">
                            <label for="recipient-name" class="col-form-label">Số điện thoại:</label>
                            <input type="text" class="form-control" id="recipient-name" value="<?=$_SESSION['user']['sdt']?>"name="phone">
                        </div>
                        <div class="form-group">
                            <label for="recipient-name" class="col-form-label">Địa chỉ:</label>
                            <input type="text" class="form-control" id="recipient-name" value="" placeholder="Nhập số địa chỉ" name="address">
                        </div>
                        <div class="form-group">
                            <label for="recipient-name" class="col-form-label">Hình ảnh:</label>
                            <input type="file" class="form-control" id="recipient-name" value="" name=img>
                        </div>
        </form>
    </div>
    <div class="modal-footer">
        <button type="button" class="btn btn-secondary" data-dismiss="modal">Đóng</button>
        <input type="submit" name="btn_update_user" class="btn btn-primary" value="Lưu Lại">
    </div>
    </div>
    </div>
    </form>
