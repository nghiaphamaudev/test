                ...
                <tbody>
                        ...
                        ?>
                                <tr>
                                    ...
                                    <td>
                                        <a href="../../../../Du_an_1/Controller/index_admin.php?request=detail-bill&id_bill=<?=$id_hoa_don?>" class="btn btn-primary status pending">Chi tiết</a>
                                    </td>
                                    <td>
                                        <?php if($trang_thai !== 3 && $trang_thai !== 1 && $trang_thai !== 2){
                                            echo '<a href="../../../../Du_an_1/Controller/index_admin.php?request=edit-bill&id_bill='.$id_hoa_don.'" class="badge badge-pill badge-info">Sửa</a>';
                                        }?>
                                    </td>
                                </tr>
                        <?php }
