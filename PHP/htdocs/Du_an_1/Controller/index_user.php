            ...
            case 'login-user':
                if(isset($_POST['login']) && $_POST['login']){
                    ...
                    if(is_array($data_user)){
                        ...
                        echo '<script>alert("Đăng nhập thành công!");window.location="../../Du_an_1/Controller/index_user.php";</script>';
                    } else {
                        echo '<script>alert("Tài khoản hoặc mật khẩu không chính xác");window.location="../../Du_an_1/View/User/login.php";</script>';
                    }
                }
                break;
        //Quên mật khẩu
                ...
                if(isset($_POST['btn_forgot_pass']) && $_POST['btn_forgot_pass']){
                    ...
                    if(is_array($data_user)){
                        if($pass1 === $pass2){
                            ...
                            echo '<script>alert("Cập nhật thành công. Vui lòng đăng nhập lại");window.location="../../Du_an_1/View/User/login.php";</script>';
                        }else{
                            echo '<script>alert("Mật khẩu không khớp!");window.location="../../Du_an_1/View/User/login.php";</script>';
                        }
                    }else{
                        echo '<script>alert("Tài khoản không tồn tại");window.location="../../Du_an_1/View/User/login.php";</script>';
                    }
                }
                break;
            ...
            case 'log-out':
                session_destroy();
                header('Location: ../../../../Du_an_1/Controller/index_user.php');
                break;
            ...
            case 'add-cart':
                if(isset($_SESSION['user'])){
                    ...
                    header('Location: ../../../../Du_an_1/Controller/index_user.php?request=cart');
                }else{
                    echo '<script>alert("Vui lòng đăng nhập để mua hàng");window.location="../../Du_an_1/View/User/login.php";</script>';
                }
                break;
            ...
            case 'addtional-address':
                if(isset($_POST['submit']) && $_POST['submit']){
                 ...
                 header('Location: ../../../../Du_an_1/Controller/index_user.php?request=payment');
                 break;
            ...
            case 'confirm-payment':
                ...
                header('Location:../../../../Du_an_1/Controller/index_user.php?request=history-bill');
                break;
            ...
            case 'transport':
                include '../View/User/hoadon/danggiao.php';
                break;
            ...
            case 'received-product':
                if(isset($_GET['id_bill']) && $_GET['id_bill']){
                    ...
                    $_SESSION['success_message'] = 'Xác nhận thành công thành công!!';
                }
                header('Location:../../../../Du_an_1/Controller/index_user.php?request=complete');
                break;
